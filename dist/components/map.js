...
var BaiduMap = (function () {
    function BaiduMap(el) {
        ...
        this.onMarkerDbClicked = new EventEmitter();
        this.onMarkerRightClicked = new EventEmitter();
        this.onMarkerDragStart = new EventEmitter();
        this.onMarkerDragEnd = new EventEmitter();
        this.onMapDblClicked = new EventEmitter();
...
BaiduMap.propDecorators = {
    ...
    'onMarkerDbClicked': [{ type: Output },],
    'onMarkerRightClicked': [{ type: Output },],
    'onMarkerDragStart': [{ type: Output },],
    'onMarkerDragEnd': [{ type: Output },],
    'onMapDblClicked': [{ type: Output },],
